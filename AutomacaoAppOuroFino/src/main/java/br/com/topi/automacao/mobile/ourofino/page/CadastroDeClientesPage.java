...
public class CadastroDeClientesPage extends BasePage {
	...
	public void gerarScreenchot(String nome) {
		...
		try {
			FileUtils.copyFile(imagem,
					new File("target/Screenshots/CadastroClientes/" + "CadastroCliente" + testName.getMethodName() + nome + ".png"));
		} catch (IOException e) {
	...
	public void clickVoltar() {
		click(By.id("br.com.topinformation.ourofinosalesforce:id/button_back_account_registration"));
	}
